    ...
    if (
        ...
        var categoriesChart = new Chart(g, {
            ...
            data: {
                ...
                datasets: [{ data: [25, 10, 15, 30, 12], backgroundColor: ["rgb(" + t.primary + "/ .1)", "rgb(" + t.primary + "/ .5)", "rgb(" + t.primary + "/ .25)"], borderColor: "rgb(" + t.primary + ")", borderWidth: 2 }],
            },
            options: {
        ...
        g &&
            ...
            new Chart(g, {
                ...
                data: {
                    labels: ["January", "February", "March", "April", "May", "June"],
                    datasets: [
                        { label: "Pending", data: [5, 10, 15, 10, 15, 10], backgroundColor: "rgb(" + t.primary + "/ .1)", borderColor: "rgb(" + t.primary + ")", borderWidth: 2 },
                        { label: "Working", data: [7.5, 10, 17.5, 15, 12.5, 5], backgroundColor: "rgb(" + t.primary + "/ .5)", borderColor: "rgb(" + t.primary + ")", borderWidth: 2 },
                    ],
                },
                options: {
                    plugins: { legend: { position: "bottom", labels: { usePointStyle: !0, padding: 20 } }, tooltip: r },
