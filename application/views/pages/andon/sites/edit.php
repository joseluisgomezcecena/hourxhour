			...
			<div class="lg:col-span-2 xl:col-span-2">
				...
				<select class="form-control" id="plant_id" name="plant_id" required>
					...
					<?php foreach ($plants as $plant) : ?>
						<option <?php if($site['plant_id'] == $plant['plant_id']){echo "selected";}else{echo "";} ?> value="<?php echo $plant["plant_id"] ?>"><?php echo $plant["plant_name"] ?></option>
					<?php endforeach; ?>
				</select>
			</div>
			<div class="lg:col-span-2 xl:col-span-2">
				<label class="label block mb-2" for="site_id">Area name:</label>
				<input class="form-control"  id="site_id" name="site_name" value="<?php echo $site['site_name']; ?>">
			</div>
		</div>
