	...
	<section class="breadcrumb" ng-app='myapp'>
		...
		<div ng-controller='userCtrl'>
			...
			<select ng-options="p.plant_id as p.plant_name for p in plants" ng-model="selected_plant" ng-change="change_plant()"></select>


			<select ng-options="p.site_id as s.site_name for s in sites" ng-model="selected_site" ng-change="change_site()"></select>
