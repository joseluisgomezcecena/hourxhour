                        ...
                        foreach ($shift['assets'] as $asset) {
                            ...
                            foreach ($production_plan['plan_by_hours'] as $plan_by_hour) {
                                ...
                                if ($plan_by_hour['planned'] == null)
                                    ...
                                    echo '<div>  <span id="span_completed_plan_by_hour_id_' . $plan_by_hour['plan_by_hour_id'] . '"><input class="input_completed" id="get_value_completed_' . $plan_by_hour['plan_by_hour_id'] . '" onchange="input_change(' . $plan_by_hour['plan_by_hour_id'] . ')" disabled value="' . $plan_by_hour['completed'] . '" /></span><span>/</span><span>' . $plan_by_hour['planned'] . '</span> </div>';
                                echo '</td>';
                            }
                            echo '</tr>';
                            echo '</tbody>';
