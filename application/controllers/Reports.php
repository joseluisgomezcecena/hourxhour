...
class Reports extends CI_Controller
{
    ...
    {
        $date_start = date(DATE_FORMAT) . ' 0:00:00';
        $date_end = date(DATE_FORMAT) . ' 23:59:59';
       ...
       AND plan_by_hours.time BETWEEN '$date_start' AND '$date_end'
       ...
       INNER JOIN sites ON assets.site_id = sites.site_id
       INNER JOIN plants ON sites.plant_id = plants.plant_id
       WHERE plan_by_hours.time BETWEEN '$date_start' AND '$date_end';");
